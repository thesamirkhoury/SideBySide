    ...
    <div className="sidebar-user">
      <div className="upper-items">
        ...
        >
          <div className="single-item">
            <p style={{fontWeight:`${lectImgFilled ? 'bold': ''}`}}>סדנאות</p>
            <img
        ...
        >
          <div className="single-item">
            <p style={{fontWeight:`${coupImgFilled ? 'bold': ''}`}}>הטבות</p>
            <img
        ...
        <NavLink
          ...
          className={({ isActive }) =>  isActive ? setTickImgFilled(true) : setTickImgFilled(false)}
        >
          <div className="single-item">
      ...
      <div className="lower-items">
        <NavLink
          ...
          className={({ isActive }) =>  isActive ? setSetImgFilled(true) : setSetImgFilled(false)}
        >
          <div className="single-item">
            <p style={{fontWeight:`${setImgFilled ? 'bold': ''}`}}>הגדרות</p>
            <img
